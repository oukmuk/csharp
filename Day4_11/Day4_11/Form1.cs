...
namespace Day4_11
{
    public partial class Form1 : Form
    {
        ...
        private void rdoSoccor_CheckedChanged(object sender, EventArgs e)
        {
            this.selectedSports = (Sports)0;
            lblSports.Text = selectedSports + "(을)를 선택했습니다"; 
        }

        private void radBaseBall_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void radTkd_CheckedChanged(object sender, EventArgs e)
        {
